...
def test_download_and_hash_csv_spa_route() -> None:
    ...
    with (
        patch(
            "coreason_etl_purple_book.source.FdaPurpleBookSource.get_latest_csv_url",
        ...
        _file_path, _md5_digest = source.download_and_hash_csv(test_url)
